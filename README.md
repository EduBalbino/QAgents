...
```bash
EDGE_PHASE=explore EDGE_SWEEP_SAMPLE=120000 EDGE_TEST_SIZE=0.1666667 EDGE_STRATIFY=1 EDGE_EXPLORE_COUNT=8 EDGE_EXPAND_COUNT=0 uv run python scripts/QML_ML-EdgeIIoT-benchmark.py
```

Other useful runs
- Grid sanity check (defaults): `WANDB_DISABLED=1 EDGE_MODE=grid uv run python scripts/QML_ML-EdgeIIoT-benchmark.py`
- RF baseline (all features → PLS-8): `WANDB_DISABLED=1 EDGE_MODE=rf EDGE_STRATIFY=1 uv run python scripts/QML_ML-EdgeIIoT-benchmark.py`
...
- Run (examples):
  - Explore sweep: `WANDB_DISABLED=1 EDGE_PHASE=explore EDGE_SWEEP_SAMPLE=120000 EDGE_TEST_SIZE=0.1666667 EDGE_STRATIFY=1 EDGE_EXPLORE_COUNT=8 EDGE_EXPAND_COUNT=0 uv run python scripts/QML_ML-EdgeIIoT-benchmark.py`
  - Grid: `WANDB_DISABLED=1 EDGE_MODE=grid uv run python scripts/QML_ML-EdgeIIoT-benchmark.py`
  - RF baseline: `WANDB_DISABLED=1 EDGE_MODE=rf EDGE_STRATIFY=1 uv run python scripts/QML_ML-EdgeIIoT-benchmark.py`
