module @qnode_forward {
  func.func public @jit_qnode_forward(%arg0: tensor<4x8x3xf32>, %arg1: tensor<8xf32>) -> tensor<f64> attributes {llvm.emit_c_interface} {
    %0 = catalyst.launch_kernel @module_qnode_forward::@qnode_forward(%arg0, %arg1) : (tensor<4x8x3xf32>, tensor<8xf32>) -> tensor<f64>
    return %0 : tensor<f64>
  }
