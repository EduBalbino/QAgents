...
log_filename = os.path.join(log_dir, f"QML_ML-EdgeIIoT_{timestamp}.log")
...
df = load_and_sample_csv('data/ML-EdgeIIoT-dataset.csv', DEV_RUN_SAMPLE_SIZE)
print(f"Dataset loaded. Final shape: {df.shape}")
print(f"Dataset Columns: {df.columns}")
# --- END FIX ---

# --- FIX: Define features and correct label column ---
features = [
    'icmp.checksum',
    'icmp.seq_le',
    'http.content_length',
