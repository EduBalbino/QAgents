module @train_epoch_compiled {
  func.func public @jit_train_epoch_compiled(%arg0: tensor<4x8x3xf32>, %arg1: tensor<f32>, %arg2: tensor<f32>, %arg3: tensor<i32>, %arg4: tensor<2xui32>, %arg5: tensor<96x8xf32>, %arg6: tensor<96xf32>, %arg7: tensor<96xf32>) -> (tensor<4x8x3xf32>, tensor<f32>, tensor<f32>, tensor<i32>, tensor<2xui32>, tensor<2xf64>) attributes {llvm.emit_c_interface} {
    ...
    %6:5 = scf.for %arg8 = %c0 to %c3 step %c1 iter_args(%arg9 = %arg0, %arg10 = %arg1, %arg11 = %arg2, %arg12 = %cst_2, %arg13 = %cst_2) -> (tensor<4x8x3xf32>, tensor<f32>, tensor<f32>, tensor<f64>, tensor<f64>) {
      ...
      %13:4 = scf.for %arg14 = %c0 to %c32 step %c1 iter_args(%arg15 = %12, %arg16 = %cst_2, %arg17 = %cst_2, %arg18 = %cst_2) -> (tensor<4x8x3xf32>, tensor<f64>, tensor<f64>, tensor<f64>) {
        %31 = arith.index_cast %arg14 : index to i64
        ...
        %53 = catalyst.launch_kernel @module_qnode_forward::@qnode_forward(%arg9, %42) : (tensor<4x8x3xf32>, tensor<8xf32>) -> tensor<f64>
        ...
        %65 = stablehlo.add %arg15, %64#0 : tensor<4x8x3xf32>
        %66 = stablehlo.convert %64#1 : (tensor<f32>) -> tensor<f64>
        %67 = stablehlo.add %arg16, %66 : tensor<f64>
        %68 = stablehlo.convert %64#2 : (tensor<f32>) -> tensor<f64>
        %69 = stablehlo.add %arg17, %68 : tensor<f64>
        %70 = stablehlo.add %arg18, %63 : tensor<f64>
      ...
      %30 = stablehlo.add %arg12, %29 : tensor<f64>
      scf.yield %18, %23, %28, %30, %29 : tensor<4x8x3xf32>, tensor<f32>, tensor<f32>, tensor<f64>, tensor<f64>
    }
    %7 = stablehlo.divide %6#3, %cst : tensor<f64>
    %8 = stablehlo.broadcast_in_dim %7, dims = [] : (tensor<f64>) -> tensor<1xf64>
    %9 = stablehlo.broadcast_in_dim %6#4, dims = [] : (tensor<f64>) -> tensor<1xf64>
    %10 = stablehlo.concatenate %8, %9, dim = 0 : (tensor<1xf64>, tensor<1xf64>) -> tensor<2xf64>
    return %6#0, %6#1, %6#2, %arg3, %2, %10 : tensor<4x8x3xf32>, tensor<f32>, tensor<f32>, tensor<i32>, tensor<2xui32>, tensor<2xf64>
  }
  ...
  module @module_qnode_forward {
    module attributes {transform.with_named_sequence} {
      transform.named_sequence @__transform_main(%arg0: !transform.op<"builtin.module">) {
        transform.yield 
      }
    }
    func.func public @qnode_forward(%arg0: tensor<4x8x3xf32>, %arg1: tensor<8xf32>) -> tensor<f64> attributes {diff_method = "adjoint", llvm.linkage = #llvm.linkage<internal>, qnode} {
  ...
  func.func private @_sample_loss(%arg0: tensor<4x8x3xf32>, %arg1: tensor<f32>, %arg2: tensor<f32>, %arg3: tensor<8xf32>, %arg4: tensor<f32>, %arg5: tensor<f32>) -> tensor<f64> attributes {llvm.linkage = #llvm.linkage<internal>} {
    %0 = catalyst.launch_kernel @module_qnode_forward::@qnode_forward(%arg0, %arg3) : (tensor<4x8x3xf32>, tensor<8xf32>) -> tensor<f64>
