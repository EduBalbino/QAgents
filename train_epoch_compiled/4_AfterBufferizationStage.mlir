module @train_epoch_compiled {
  memref.global "private" constant @__constant_xi64_4 : memref<i64> = dense<32> {alignment = 64 : i64}
  memref.global "private" constant @__constant_4xi32_3 : memref<4xi32> = dense<[13, 15, 26, 6]> {alignment = 64 : i64}
  memref.global "private" constant @__constant_4xi32 : memref<4xi32> = dense<[17, 29, 16, 24]> {alignment = 64 : i64}
  memref.global "private" constant @__constant_xi64 : memref<i64> = dense<1> {alignment = 64 : i64}
  memref.global "private" constant @__constant_xf32_2 : memref<f32> = dense<0.000000e+00> {alignment = 64 : i64}
  memref.global "private" constant @__constant_xf32_1 : memref<f32> = dense<0.00999999977> {alignment = 64 : i64}
  memref.global "private" constant @__constant_xf32_0 : memref<f32> = dense<3.125000e-02> {alignment = 64 : i64}
  memref.global "private" constant @__constant_xf32 : memref<f32> = dense<3.14159274> {alignment = 64 : i64}
  func.func public @jit_train_epoch_compiled(%arg0: memref<4x8x3xf32>, %arg1: memref<f32>, %arg2: memref<f32>, %arg3: memref<i32>, %arg4: memref<2xi32>, %arg5: memref<96x8xf32>, %arg6: memref<96xf32>, %arg7: memref<96xf32>) -> (memref<4x8x3xf32>, memref<f32>, memref<f32>, memref<i32>, memref<2xi32>, memref<2xf64>) attributes {llvm.copy_memref, llvm.emit_c_interface} {
    ...
    %1 = memref.get_global @__constant_xf32_0 : memref<f32>
    %2 = memref.get_global @__constant_xf32_1 : memref<f32>
    %3 = memref.get_global @__constant_xf32_2 : memref<f32>
    %4 = memref.get_global @__constant_xi64 : memref<i64>
    %5 = memref.get_global @__constant_4xi32 : memref<4xi32>
    %6 = memref.get_global @__constant_4xi32_3 : memref<4xi32>
    %7 = memref.get_global @__constant_xi64_4 : memref<i64>
    %subview = memref.subview %arg4[0] [1] [1] : memref<2xi32> to memref<1xi32, strided<[1]>>
    %collapse_shape = memref.collapse_shape %subview [] : memref<1xi32, strided<[1]>> into memref<i32>
    %8 = memref.load %collapse_shape[] : memref<i32>
    %subview_5 = memref.subview %arg4[1] [1] [1] : memref<2xi32> to memref<1xi32, strided<[1], offset: 1>>
    %collapse_shape_6 = memref.collapse_shape %subview_5 [] : memref<1xi32, strided<[1], offset: 1>> into memref<i32, strided<[], offset: 1>>
    %9 = memref.load %collapse_shape_6[] : memref<i32, strided<[], offset: 1>>
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<2xi64>
    %alloc_7 = memref.alloc() {alignment = 64 : i64} : memref<2xi64>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} outs(%alloc_7 : memref<2xi64>) {
    ^bb0(%out: i64):
      %87 = linalg.index 0 : index
      %88 = arith.index_cast %87 : index to i64
      linalg.yield %88 : i64
    }
    linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%4 : memref<i64>) outs(%alloc : memref<2xi64>) {
    ^bb0(%in: i64, %out: i64):
      linalg.yield %in : i64
    }
    %alloc_8 = memref.alloc() {alignment = 64 : i64} : memref<2xi64>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc, %alloc_7 : memref<2xi64>, memref<2xi64>) outs(%alloc_8 : memref<2xi64>) {
    ^bb0(%in: i64, %in_121: i64, %out: i64):
      %87 = arith.muli %in, %in_121 : i64
      linalg.yield %87 : i64
    }
    memref.dealloc %alloc_7 : memref<2xi64>
    linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%7 : memref<i64>) outs(%alloc : memref<2xi64>) {
    ^bb0(%in: i64, %out: i64):
      linalg.yield %in : i64
    }
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_8, %alloc : memref<2xi64>, memref<2xi64>) outs(%alloc : memref<2xi64>) {
    ^bb0(%in: i64, %in_121: i64, %out: i64):
      %87 = arith.shrui %in, %in_121 : i64
      %88 = arith.cmpi ult, %in_121, %c64_i64 : i64
      %89 = arith.select %88, %87, %c0_i64 : i64
      linalg.yield %89 : i64
    }
    %alloc_9 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_10 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_8 : memref<2xi64>) outs(%alloc_10 : memref<2xi32>) {
    ^bb0(%in: i64, %out: i32):
      %87 = arith.trunci %in : i64 to i32
      linalg.yield %87 : i32
    }
    memref.dealloc %alloc_8 : memref<2xi64>
    %alloc_11 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc : memref<2xi64>) outs(%alloc_11 : memref<2xi32>) {
    ^bb0(%in: i64, %out: i32):
      %87 = arith.trunci %in : i64 to i32
      linalg.yield %87 : i32
    }
    memref.dealloc %alloc : memref<2xi64>
    %10 = arith.xori %8, %9 : i32
    %11 = arith.xori %10, %c466688986_i32 : i32
    linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%collapse_shape : memref<i32>) outs(%alloc_9 : memref<2xi32>) {
    ^bb0(%in: i32, %out: i32):
      linalg.yield %in : i32
    }
    %alloc_12 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_11, %alloc_9 : memref<2xi32>, memref<2xi32>) outs(%alloc_12 : memref<2xi32>) {
    ^bb0(%in: i32, %in_121: i32, %out: i32):
      %87 = arith.addi %in, %in_121 : i32
      linalg.yield %87 : i32
    }
    memref.dealloc %alloc_11 : memref<2xi32>
    linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%collapse_shape_6 : memref<i32, strided<[], offset: 1>>) outs(%alloc_9 : memref<2xi32>) {
    ^bb0(%in: i32, %out: i32):
      linalg.yield %in : i32
    }
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_10, %alloc_9 : memref<2xi32>, memref<2xi32>) outs(%alloc_9 : memref<2xi32>) {
    ^bb0(%in: i32, %in_121: i32, %out: i32):
      %87 = arith.addi %in, %in_121 : i32
      linalg.yield %87 : i32
    }
    memref.dealloc %alloc_10 : memref<2xi32>
    %12 = memref.load %collapse_shape_6[] : memref<i32, strided<[], offset: 1>>
    %13 = memref.load %collapse_shape[] : memref<i32>
    %alloc_13 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
    memref.copy %6, %alloc_13 : memref<4xi32> to memref<4xi32>
    %alloc_14 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
    memref.copy %5, %alloc_14 : memref<4xi32> to memref<4xi32>
    %alloc_15 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_16 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_17 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_18 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_19 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_20 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_21 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_22 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_23 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_24 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_25 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_26 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_27 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_28 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_29 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_30 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_31 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_32 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_33 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_34 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_35 = memref.alloc() : memref<2xi32>
    memref.copy %alloc_9, %alloc_35 : memref<2xi32> to memref<2xi32>
    memref.dealloc %alloc_9 : memref<2xi32>
    %alloc_36 = memref.alloc() : memref<2xi32>
    memref.copy %alloc_12, %alloc_36 : memref<2xi32> to memref<2xi32>
    memref.dealloc %alloc_12 : memref<2xi32>
    %alloc_37 = memref.alloc() : memref<4xi32>
    memref.copy %alloc_13, %alloc_37 : memref<4xi32> to memref<4xi32>
    memref.dealloc %alloc_13 : memref<4xi32>
    %alloc_38 = memref.alloc() : memref<4xi32>
    memref.copy %alloc_14, %alloc_38 : memref<4xi32> to memref<4xi32>
    memref.dealloc %alloc_14 : memref<4xi32>
    %14:8 = scf.for %arg8 = %c0_i64 to %c5_i64 step %c1_i64 iter_args(%arg9 = %c0_i64, %arg10 = %alloc_36, %arg11 = %alloc_35, %arg12 = %12, %arg13 = %11, %arg14 = %13, %arg15 = %alloc_37, %arg16 = %alloc_38) -> (i64, memref<2xi32>, memref<2xi32>, i32, i32, i32, memref<4xi32>, memref<4xi32>)  : i64 {
      memref.store %arg12, %alloc_15[] : memref<i32>
      memref.store %arg13, %alloc_16[] : memref<i32>
      %87 = arith.addi %arg9, %c1_i64 : i64
      %subview_121 = memref.subview %arg15[0] [1] [1] : memref<4xi32> to memref<1xi32, strided<[1]>>
      %collapse_shape_122 = memref.collapse_shape %subview_121 [] : memref<1xi32, strided<[1]>> into memref<i32>
      %88 = memref.load %collapse_shape_122[] : memref<i32>
      %alloc_123 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%arg10, %arg11 : memref<2xi32>, memref<2xi32>) outs(%alloc_17 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      memref.dealloc %arg10 : memref<2xi32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%collapse_shape_122 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%arg11, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_18 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shli %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
        linalg.yield %99 : i32
      }
      %89 = arith.subi %c32_i32, %88 : i32
      memref.store %89, %alloc_19[] : memref<i32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_19 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%arg11, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shrui %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
        linalg.yield %99 : i32
      }
      memref.dealloc %arg11 : memref<2xi32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_18, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.ori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_17, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_20 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.xori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      %subview_124 = memref.subview %arg15[1] [1] [1] : memref<4xi32> to memref<1xi32, strided<[1], offset: 1>>
      %collapse_shape_125 = memref.collapse_shape %subview_124 [] : memref<1xi32, strided<[1], offset: 1>> into memref<i32, strided<[], offset: 1>>
      %90 = memref.load %collapse_shape_125[] : memref<i32, strided<[], offset: 1>>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_17, %alloc_20 : memref<2xi32>, memref<2xi32>) outs(%alloc_21 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%collapse_shape_125 : memref<i32, strided<[], offset: 1>>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_20, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_22 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shli %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      %91 = arith.subi %c32_i32, %90 : i32
      memref.store %91, %alloc_23[] : memref<i32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_23 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_20, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shrui %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_22, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.ori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_21, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_24 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.xori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      %subview_126 = memref.subview %arg15[2] [1] [1] : memref<4xi32> to memref<1xi32, strided<[1], offset: 2>>
      %collapse_shape_127 = memref.collapse_shape %subview_126 [] : memref<1xi32, strided<[1], offset: 2>> into memref<i32, strided<[], offset: 2>>
      %92 = memref.load %collapse_shape_127[] : memref<i32, strided<[], offset: 2>>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_21, %alloc_24 : memref<2xi32>, memref<2xi32>) outs(%alloc_25 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%collapse_shape_127 : memref<i32, strided<[], offset: 2>>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_24, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_26 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shli %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      %93 = arith.subi %c32_i32, %92 : i32
      memref.store %93, %alloc_27[] : memref<i32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_27 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_24, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shrui %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_26, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.ori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_25, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_28 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.xori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      %subview_128 = memref.subview %arg15[3] [1] [1] : memref<4xi32> to memref<1xi32, strided<[1], offset: 3>>
      %collapse_shape_129 = memref.collapse_shape %subview_128 [] : memref<1xi32, strided<[1], offset: 3>> into memref<i32, strided<[], offset: 3>>
      %94 = memref.load %collapse_shape_129[] : memref<i32, strided<[], offset: 3>>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_25, %alloc_28 : memref<2xi32>, memref<2xi32>) outs(%alloc_29 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%collapse_shape_129 : memref<i32, strided<[], offset: 3>>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_28, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_30 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shli %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      %95 = arith.subi %c32_i32, %94 : i32
      memref.store %95, %alloc_31[] : memref<i32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_31 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_28, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shrui %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_30, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.ori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_29, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_32 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.xori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_15 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      %alloc_130 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_29, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_130 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_16 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_32, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_33 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      %96 = arith.trunci %87 : i64 to i32
      memref.store %96, %alloc_34[] : memref<i32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_34 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_33, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      %alloc_131 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
      memref.copy %arg16, %alloc_131 : memref<4xi32> to memref<4xi32>
      memref.dealloc %arg16 : memref<4xi32>
      %alloc_132 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
      memref.copy %arg15, %alloc_132 : memref<4xi32> to memref<4xi32>
      memref.dealloc %arg15 : memref<4xi32>
      %alloc_133 = memref.alloc() : memref<2xi32>
      memref.copy %alloc_123, %alloc_133 : memref<2xi32> to memref<2xi32>
      memref.dealloc %alloc_123 : memref<2xi32>
      %alloc_134 = memref.alloc() : memref<2xi32>
      memref.copy %alloc_130, %alloc_134 : memref<2xi32> to memref<2xi32>
      memref.dealloc %alloc_130 : memref<2xi32>
      %alloc_135 = memref.alloc() : memref<4xi32>
      memref.copy %alloc_131, %alloc_135 : memref<4xi32> to memref<4xi32>
      memref.dealloc %alloc_131 : memref<4xi32>
      %alloc_136 = memref.alloc() : memref<4xi32>
      memref.copy %alloc_132, %alloc_136 : memref<4xi32> to memref<4xi32>
      memref.dealloc %alloc_132 : memref<4xi32>
      scf.yield %87, %alloc_134, %alloc_133, %arg13, %arg14, %arg12, %alloc_135, %alloc_136 : i64, memref<2xi32>, memref<2xi32>, i32, i32, i32, memref<4xi32>, memref<4xi32>
    }
    memref.dealloc %14#7 : memref<4xi32>
    memref.dealloc %14#6 : memref<4xi32>
    memref.dealloc %alloc_34 : memref<i32>
    memref.dealloc %alloc_33 : memref<2xi32>
    memref.dealloc %alloc_32 : memref<2xi32>
    memref.dealloc %alloc_31 : memref<i32>
    memref.dealloc %alloc_30 : memref<2xi32>
    memref.dealloc %alloc_29 : memref<2xi32>
    memref.dealloc %alloc_28 : memref<2xi32>
    memref.dealloc %alloc_27 : memref<i32>
    memref.dealloc %alloc_26 : memref<2xi32>
    memref.dealloc %alloc_25 : memref<2xi32>
    memref.dealloc %alloc_24 : memref<2xi32>
    memref.dealloc %alloc_23 : memref<i32>
    memref.dealloc %alloc_22 : memref<2xi32>
    memref.dealloc %alloc_21 : memref<2xi32>
    memref.dealloc %alloc_20 : memref<2xi32>
    memref.dealloc %alloc_19 : memref<i32>
    memref.dealloc %alloc_18 : memref<2xi32>
    memref.dealloc %alloc_17 : memref<2xi32>
    memref.dealloc %alloc_16 : memref<i32>
    memref.dealloc %alloc_15 : memref<i32>
    %expand_shape = memref.expand_shape %14#1 [[0, 1]] output_shape [2, 1] : memref<2xi32> into memref<2x1xi32>
    %expand_shape_39 = memref.expand_shape %14#2 [[0, 1]] output_shape [2, 1] : memref<2xi32> into memref<2x1xi32>
    %alloc_40 = memref.alloc() {alignment = 64 : i64} : memref<2x2xi32>
    linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} outs(%alloc_40 : memref<2x2xi32>) {
    ^bb0(%out: i32):
      %87 = linalg.index 0 : index
      %88 = linalg.index 1 : index
      %89 = arith.cmpi ult, %88, %c1 : index
      %90 = scf.if %89 -> (i32) {
        %91 = memref.load %expand_shape[%87, %88] : memref<2x1xi32>
        scf.yield %91 : i32
      } else {
        %91 = arith.subi %88, %c1 : index
        %92 = memref.load %expand_shape_39[%87, %91] : memref<2x1xi32>
        scf.yield %92 : i32
      }
      linalg.yield %90 : i32
    }
    memref.dealloc %14#1 : memref<2xi32>
    memref.dealloc %14#2 : memref<2xi32>
    %subview_41 = memref.subview %alloc_40[0, 0] [1, 2] [1, 1] : memref<2x2xi32> to memref<1x2xi32, strided<[2, 1]>>
    %collapse_shape_42 = memref.collapse_shape %subview_41 [[0, 1]] : memref<1x2xi32, strided<[2, 1]>> into memref<2xi32, strided<[1]>>
    %subview_43 = memref.subview %alloc_40[1, 0] [1, 2] [1, 1] : memref<2x2xi32> to memref<1x2xi32, strided<[2, 1], offset: 2>>
    %collapse_shape_44 = memref.collapse_shape %subview_43 [[0, 1]] : memref<1x2xi32, strided<[2, 1], offset: 2>> into memref<2xi32, strided<[1], offset: 2>>
    %subview_45 = memref.subview %collapse_shape_44[0] [1] [1] : memref<2xi32, strided<[1], offset: 2>> to memref<1xi32, strided<[1], offset: 2>>
    %collapse_shape_46 = memref.collapse_shape %subview_45 [] : memref<1xi32, strided<[1], offset: 2>> into memref<i32, strided<[], offset: 2>>
    %15 = memref.load %collapse_shape_46[] : memref<i32, strided<[], offset: 2>>
    %subview_47 = memref.subview %collapse_shape_44[1] [1] [1] : memref<2xi32, strided<[1], offset: 2>> to memref<1xi32, strided<[1], offset: 3>>
    %collapse_shape_48 = memref.collapse_shape %subview_47 [] : memref<1xi32, strided<[1], offset: 3>> into memref<i32, strided<[], offset: 3>>
    %16 = memref.load %collapse_shape_48[] : memref<i32, strided<[], offset: 3>>
    %alloc_49 = memref.alloc() {alignment = 64 : i64} : memref<2xi64>
    %alloc_50 = memref.alloc() {alignment = 64 : i64} : memref<2xi64>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} outs(%alloc_50 : memref<2xi64>) {
    ^bb0(%out: i64):
      %87 = linalg.index 0 : index
      %88 = arith.index_cast %87 : index to i64
      linalg.yield %88 : i64
    }
    linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%4 : memref<i64>) outs(%alloc_49 : memref<2xi64>) {
    ^bb0(%in: i64, %out: i64):
      linalg.yield %in : i64
    }
    %alloc_51 = memref.alloc() {alignment = 64 : i64} : memref<2xi64>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_49, %alloc_50 : memref<2xi64>, memref<2xi64>) outs(%alloc_51 : memref<2xi64>) {
    ^bb0(%in: i64, %in_121: i64, %out: i64):
      %87 = arith.muli %in, %in_121 : i64
      linalg.yield %87 : i64
    }
    memref.dealloc %alloc_50 : memref<2xi64>
    linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%7 : memref<i64>) outs(%alloc_49 : memref<2xi64>) {
    ^bb0(%in: i64, %out: i64):
      linalg.yield %in : i64
    }
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_51, %alloc_49 : memref<2xi64>, memref<2xi64>) outs(%alloc_49 : memref<2xi64>) {
    ^bb0(%in: i64, %in_121: i64, %out: i64):
      %87 = arith.shrui %in, %in_121 : i64
      %88 = arith.cmpi ult, %in_121, %c64_i64 : i64
      %89 = arith.select %88, %87, %c0_i64 : i64
    ...
    %alloc_52 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_53 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_51 : memref<2xi64>) outs(%alloc_53 : memref<2xi32>) {
    ^bb0(%in: i64, %out: i32):
      %87 = arith.trunci %in : i64 to i32
      linalg.yield %87 : i32
    }
    memref.dealloc %alloc_51 : memref<2xi64>
    %alloc_54 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_49 : memref<2xi64>) outs(%alloc_54 : memref<2xi32>) {
    ^bb0(%in: i64, %out: i32):
      %87 = arith.trunci %in : i64 to i32
      linalg.yield %87 : i32
    }
    memref.dealloc %alloc_49 : memref<2xi64>
    %17 = arith.xori %15, %16 : i32
    %18 = arith.xori %17, %c466688986_i32 : i32
    linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%collapse_shape_46 : memref<i32, strided<[], offset: 2>>) outs(%alloc_52 : memref<2xi32>) {
    ^bb0(%in: i32, %out: i32):
      linalg.yield %in : i32
    }
    %alloc_55 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_54, %alloc_52 : memref<2xi32>, memref<2xi32>) outs(%alloc_55 : memref<2xi32>) {
    ^bb0(%in: i32, %in_121: i32, %out: i32):
      %87 = arith.addi %in, %in_121 : i32
      linalg.yield %87 : i32
    }
    memref.dealloc %alloc_54 : memref<2xi32>
    linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%collapse_shape_48 : memref<i32, strided<[], offset: 3>>) outs(%alloc_52 : memref<2xi32>) {
    ^bb0(%in: i32, %out: i32):
      linalg.yield %in : i32
    }
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_53, %alloc_52 : memref<2xi32>, memref<2xi32>) outs(%alloc_52 : memref<2xi32>) {
    ^bb0(%in: i32, %in_121: i32, %out: i32):
      %87 = arith.addi %in, %in_121 : i32
      linalg.yield %87 : i32
    }
    memref.dealloc %alloc_53 : memref<2xi32>
    %19 = memref.load %collapse_shape_48[] : memref<i32, strided<[], offset: 3>>
    %20 = memref.load %collapse_shape_46[] : memref<i32, strided<[], offset: 2>>
    %alloc_56 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
    memref.copy %6, %alloc_56 : memref<4xi32> to memref<4xi32>
    %alloc_57 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
    memref.copy %5, %alloc_57 : memref<4xi32> to memref<4xi32>
    %alloc_58 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_59 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_60 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_61 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_62 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_63 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_64 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_65 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_66 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_67 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_68 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_69 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_70 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_71 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_72 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_73 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_74 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_75 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_76 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
    %alloc_77 = memref.alloc() {alignment = 64 : i64} : memref<i32>
    %alloc_78 = memref.alloc() : memref<2xi32>
    memref.copy %alloc_52, %alloc_78 : memref<2xi32> to memref<2xi32>
    memref.dealloc %alloc_52 : memref<2xi32>
    %alloc_79 = memref.alloc() : memref<2xi32>
    memref.copy %alloc_55, %alloc_79 : memref<2xi32> to memref<2xi32>
    memref.dealloc %alloc_55 : memref<2xi32>
    %alloc_80 = memref.alloc() : memref<4xi32>
    memref.copy %alloc_56, %alloc_80 : memref<4xi32> to memref<4xi32>
    memref.dealloc %alloc_56 : memref<4xi32>
    %alloc_81 = memref.alloc() : memref<4xi32>
    memref.copy %alloc_57, %alloc_81 : memref<4xi32> to memref<4xi32>
    memref.dealloc %alloc_57 : memref<4xi32>
    %21:8 = scf.for %arg8 = %c0_i64 to %c5_i64 step %c1_i64 iter_args(%arg9 = %c0_i64, %arg10 = %alloc_79, %arg11 = %alloc_78, %arg12 = %19, %arg13 = %18, %arg14 = %20, %arg15 = %alloc_80, %arg16 = %alloc_81) -> (i64, memref<2xi32>, memref<2xi32>, i32, i32, i32, memref<4xi32>, memref<4xi32>)  : i64 {
      memref.store %arg12, %alloc_58[] : memref<i32>
      memref.store %arg13, %alloc_59[] : memref<i32>
      %87 = arith.addi %arg9, %c1_i64 : i64
      %subview_121 = memref.subview %arg15[0] [1] [1] : memref<4xi32> to memref<1xi32, strided<[1]>>
      %collapse_shape_122 = memref.collapse_shape %subview_121 [] : memref<1xi32, strided<[1]>> into memref<i32>
      %88 = memref.load %collapse_shape_122[] : memref<i32>
      %alloc_123 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%arg10, %arg11 : memref<2xi32>, memref<2xi32>) outs(%alloc_60 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      ...
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%arg11, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_61 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shli %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      %89 = arith.subi %c32_i32, %88 : i32
      memref.store %89, %alloc_62[] : memref<i32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_62 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%arg11, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ...
      memref.dealloc %arg11 : memref<2xi32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_61, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.ori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_60, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_63 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.xori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      ...
      %collapse_shape_125 = memref.collapse_shape %subview_124 [] : memref<1xi32, strided<[1], offset: 1>> into memref<i32, strided<[], offset: 1>>
      %90 = memref.load %collapse_shape_125[] : memref<i32, strided<[], offset: 1>>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_60, %alloc_63 : memref<2xi32>, memref<2xi32>) outs(%alloc_64 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      ...
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_63, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_65 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shli %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      %91 = arith.subi %c32_i32, %90 : i32
      memref.store %91, %alloc_66[] : memref<i32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_66 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_63, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shrui %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_65, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.ori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_64, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_67 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.xori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      ...
      %collapse_shape_127 = memref.collapse_shape %subview_126 [] : memref<1xi32, strided<[1], offset: 2>> into memref<i32, strided<[], offset: 2>>
      %92 = memref.load %collapse_shape_127[] : memref<i32, strided<[], offset: 2>>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_64, %alloc_67 : memref<2xi32>, memref<2xi32>) outs(%alloc_68 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      ...
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_67, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_69 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shli %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      %93 = arith.subi %c32_i32, %92 : i32
      memref.store %93, %alloc_70[] : memref<i32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_70 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_67, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shrui %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_69, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.ori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_68, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_71 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.xori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      ...
      %collapse_shape_129 = memref.collapse_shape %subview_128 [] : memref<1xi32, strided<[1], offset: 3>> into memref<i32, strided<[], offset: 3>>
      %94 = memref.load %collapse_shape_129[] : memref<i32, strided<[], offset: 3>>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_68, %alloc_71 : memref<2xi32>, memref<2xi32>) outs(%alloc_72 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      ...
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_71, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_73 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shli %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      %95 = arith.subi %c32_i32, %94 : i32
      memref.store %95, %alloc_74[] : memref<i32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_74 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_71, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.shrui %in, %in_137 : i32
        %98 = arith.cmpi ult, %in_137, %c32_i32 : i32
        %99 = arith.select %98, %97, %c0_i32 : i32
      ...
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_73, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.ori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_72, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_75 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.xori %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_58 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      %alloc_130 = memref.alloc() {alignment = 64 : i64} : memref<2xi32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_72, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_130 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_59 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_75, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_76 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
      %96 = arith.trunci %87 : i64 to i32
      memref.store %96, %alloc_77[] : memref<i32>
      linalg.generic {indexing_maps = [affine_map<(d0) -> ()>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_77 : memref<i32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %out: i32):
        linalg.yield %in : i32
      }
      linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} ins(%alloc_76, %alloc_123 : memref<2xi32>, memref<2xi32>) outs(%alloc_123 : memref<2xi32>) {
      ^bb0(%in: i32, %in_137: i32, %out: i32):
        %97 = arith.addi %in, %in_137 : i32
        linalg.yield %97 : i32
      }
    ...
    memref.dealloc %21#7 : memref<4xi32>
    memref.dealloc %21#6 : memref<4xi32>
    memref.dealloc %alloc_77 : memref<i32>
    memref.dealloc %alloc_76 : memref<2xi32>
    memref.dealloc %alloc_75 : memref<2xi32>
    memref.dealloc %alloc_74 : memref<i32>
    memref.dealloc %alloc_73 : memref<2xi32>
    memref.dealloc %alloc_72 : memref<2xi32>
    memref.dealloc %alloc_71 : memref<2xi32>
    memref.dealloc %alloc_70 : memref<i32>
    memref.dealloc %alloc_69 : memref<2xi32>
    memref.dealloc %alloc_68 : memref<2xi32>
    memref.dealloc %alloc_67 : memref<2xi32>
    memref.dealloc %alloc_66 : memref<i32>
    memref.dealloc %alloc_65 : memref<2xi32>
    memref.dealloc %alloc_64 : memref<2xi32>
    memref.dealloc %alloc_63 : memref<2xi32>
    memref.dealloc %alloc_62 : memref<i32>
    memref.dealloc %alloc_61 : memref<2xi32>
    memref.dealloc %alloc_60 : memref<2xi32>
    memref.dealloc %alloc_59 : memref<i32>
    memref.dealloc %alloc_58 : memref<i32>
    %expand_shape_82 = memref.expand_shape %21#1 [[0, 1]] output_shape [2, 1] : memref<2xi32> into memref<2x1xi32>
    %expand_shape_83 = memref.expand_shape %21#2 [[0, 1]] output_shape [2, 1] : memref<2xi32> into memref<2x1xi32>
    %alloc_84 = memref.alloc() {alignment = 64 : i64} : memref<2x2xi32>
    linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} outs(%alloc_84 : memref<2x2xi32>) {
    ^bb0(%out: i32):
      %87 = linalg.index 0 : index
      %88 = linalg.index 1 : index
      %89 = arith.cmpi ult, %88, %c1 : index
      %90 = scf.if %89 -> (i32) {
        %91 = memref.load %expand_shape_82[%87, %88] : memref<2x1xi32>
        scf.yield %91 : i32
      } else {
        %91 = arith.subi %88, %c1 : index
        %92 = memref.load %expand_shape_83[%87, %91] : memref<2x1xi32>
        scf.yield %92 : i32
      }
      linalg.yield %90 : i32
    }
    memref.dealloc %21#1 : memref<2xi32>
    memref.dealloc %21#2 : memref<2xi32>
    %subview_85 = memref.subview %alloc_84[0, 0] [1, 2] [1, 1] : memref<2x2xi32> to memref<1x2xi32, strided<[2, 1]>>
    %collapse_shape_86 = memref.collapse_shape %subview_85 [[0, 1]] : memref<1x2xi32, strided<[2, 1]>> into memref<2xi32, strided<[1]>>
    %subview_87 = memref.subview %alloc_84[1, 0] [1, 2] [1, 1] : memref<2x2xi32> to memref<1x2xi32, strided<[2, 1], offset: 2>>
    %collapse_shape_88 = memref.collapse_shape %subview_87 [[0, 1]] : memref<1x2xi32, strided<[2, 1], offset: 2>> into memref<2xi32, strided<[1], offset: 2>>
    %subview_89 = memref.subview %collapse_shape_86[0] [1] [1] : memref<2xi32, strided<[1]>> to memref<1xi32, strided<[1]>>
    %collapse_shape_90 = memref.collapse_shape %subview_89 [] : memref<1xi32, strided<[1]>> into memref<i32>
    %22 = memref.load %collapse_shape_90[] : memref<i32>
    %subview_91 = memref.subview %collapse_shape_86[1] [1] [1] : memref<2xi32, strided<[1]>> to memref<1xi32, strided<[1], offset: 1>>
    %collapse_shape_92 = memref.collapse_shape %subview_91 [] : memref<1xi32, strided<[1], offset: 1>> into memref<i32, strided<[], offset: 1>>
    %23 = memref.load %collapse_shape_92[] : memref<i32, strided<[], offset: 1>>
    %24 = arith.xori %22, %23 : i32
    %25 = arith.xori %24, %c466688986_i32 : i32
    %26 = memref.load %collapse_shape_90[] : memref<i32>
    %27 = memref.load %collapse_shape_92[] : memref<i32, strided<[], offset: 1>>
    %28 = memref.load %collapse_shape_92[] : memref<i32, strided<[], offset: 1>>
    %29 = memref.load %collapse_shape_90[] : memref<i32>
    %alloc_93 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
    memref.copy %6, %alloc_93 : memref<4xi32> to memref<4xi32>
    %alloc_94 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
    memref.copy %5, %alloc_94 : memref<4xi32> to memref<4xi32>
    %alloc_95 = memref.alloc() : memref<4xi32>
    memref.copy %alloc_93, %alloc_95 : memref<4xi32> to memref<4xi32>
    memref.dealloc %alloc_93 : memref<4xi32>
    %alloc_96 = memref.alloc() : memref<4xi32>
    memref.copy %alloc_94, %alloc_96 : memref<4xi32> to memref<4xi32>
    memref.dealloc %alloc_94 : memref<4xi32>
    %30:8 = scf.for %arg8 = %c0_i64 to %c5_i64 step %c1_i64 iter_args(%arg9 = %c0_i64, %arg10 = %26, %arg11 = %27, %arg12 = %28, %arg13 = %25, %arg14 = %29, %arg15 = %alloc_95, %arg16 = %alloc_96) -> (i64, i32, i32, i32, i32, i32, memref<4xi32>, memref<4xi32>)  : i64 {
      %87 = arith.addi %arg9, %c1_i64 : i64
      %subview_121 = memref.subview %arg15[0] [1] [1] : memref<4xi32> to memref<1xi32, strided<[1]>>
      %collapse_shape_122 = memref.collapse_shape %subview_121 [] : memref<1xi32, strided<[1]>> into memref<i32>
      %88 = memref.load %collapse_shape_122[] : memref<i32>
      %89 = arith.addi %arg10, %arg11 : i32
      %90 = arith.shli %arg11, %88 : i32
      %91 = arith.cmpi ult, %88, %c32_i32 : i32
      %92 = arith.select %91, %90, %c0_i32 : i32
      %93 = arith.subi %c32_i32, %88 : i32
      %94 = arith.shrui %arg11, %93 : i32
      %95 = arith.cmpi ult, %93, %c32_i32 : i32
      %96 = arith.select %95, %94, %c0_i32 : i32
      %97 = arith.ori %92, %96 : i32
      %98 = arith.xori %89, %97 : i32
      %subview_123 = memref.subview %arg15[1] [1] [1] : memref<4xi32> to memref<1xi32, strided<[1], offset: 1>>
      %collapse_shape_124 = memref.collapse_shape %subview_123 [] : memref<1xi32, strided<[1], offset: 1>> into memref<i32, strided<[], offset: 1>>
      %99 = memref.load %collapse_shape_124[] : memref<i32, strided<[], offset: 1>>
      %100 = arith.addi %89, %98 : i32
      %101 = arith.shli %98, %99 : i32
      %102 = arith.cmpi ult, %99, %c32_i32 : i32
      %103 = arith.select %102, %101, %c0_i32 : i32
      %104 = arith.subi %c32_i32, %99 : i32
      %105 = arith.shrui %98, %104 : i32
      %106 = arith.cmpi ult, %104, %c32_i32 : i32
      %107 = arith.select %106, %105, %c0_i32 : i32
      %108 = arith.ori %103, %107 : i32
      %109 = arith.xori %100, %108 : i32
      %subview_125 = memref.subview %arg15[2] [1] [1] : memref<4xi32> to memref<1xi32, strided<[1], offset: 2>>
      %collapse_shape_126 = memref.collapse_shape %subview_125 [] : memref<1xi32, strided<[1], offset: 2>> into memref<i32, strided<[], offset: 2>>
      %110 = memref.load %collapse_shape_126[] : memref<i32, strided<[], offset: 2>>
      %111 = arith.addi %100, %109 : i32
      %112 = arith.shli %109, %110 : i32
      %113 = arith.cmpi ult, %110, %c32_i32 : i32
      %114 = arith.select %113, %112, %c0_i32 : i32
      %115 = arith.subi %c32_i32, %110 : i32
      %116 = arith.shrui %109, %115 : i32
      %117 = arith.cmpi ult, %115, %c32_i32 : i32
      %118 = arith.select %117, %116, %c0_i32 : i32
      %119 = arith.ori %114, %118 : i32
      %120 = arith.xori %111, %119 : i32
      %subview_127 = memref.subview %arg15[3] [1] [1] : memref<4xi32> to memref<1xi32, strided<[1], offset: 3>>
      %collapse_shape_128 = memref.collapse_shape %subview_127 [] : memref<1xi32, strided<[1], offset: 3>> into memref<i32, strided<[], offset: 3>>
      %121 = memref.load %collapse_shape_128[] : memref<i32, strided<[], offset: 3>>
      %122 = arith.addi %111, %120 : i32
      %123 = arith.shli %120, %121 : i32
      %124 = arith.cmpi ult, %121, %c32_i32 : i32
      %125 = arith.select %124, %123, %c0_i32 : i32
      %126 = arith.subi %c32_i32, %121 : i32
      %127 = arith.shrui %120, %126 : i32
      %128 = arith.cmpi ult, %126, %c32_i32 : i32
      %129 = arith.select %128, %127, %c0_i32 : i32
      %130 = arith.ori %125, %129 : i32
      %131 = arith.xori %122, %130 : i32
      %132 = arith.addi %122, %arg12 : i32
      %133 = arith.addi %131, %arg13 : i32
      %134 = arith.trunci %87 : i64 to i32
      %135 = arith.addi %133, %134 : i32
      %alloc_129 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
      memref.copy %arg16, %alloc_129 : memref<4xi32> to memref<4xi32>
      memref.dealloc %arg16 : memref<4xi32>
      %alloc_130 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
      memref.copy %arg15, %alloc_130 : memref<4xi32> to memref<4xi32>
      memref.dealloc %arg15 : memref<4xi32>
      %alloc_131 = memref.alloc() : memref<4xi32>
      memref.copy %alloc_129, %alloc_131 : memref<4xi32> to memref<4xi32>
      memref.dealloc %alloc_129 : memref<4xi32>
      %alloc_132 = memref.alloc() : memref<4xi32>
      memref.copy %alloc_130, %alloc_132 : memref<4xi32> to memref<4xi32>
      memref.dealloc %alloc_130 : memref<4xi32>
      scf.yield %87, %132, %135, %arg13, %arg14, %arg12, %alloc_131, %alloc_132 : i64, i32, i32, i32, i32, i32, memref<4xi32>, memref<4xi32>
    }
    memref.dealloc %30#7 : memref<4xi32>
    memref.dealloc %30#6 : memref<4xi32>
    %31 = arith.extui %30#1 : i32 to i64
    %32 = arith.extui %30#2 : i32 to i64
    %33 = arith.shli %31, %c32_i64 : i64
    %34 = arith.ori %33, %32 : i64
    %subview_97 = memref.subview %collapse_shape_88[0] [1] [1] : memref<2xi32, strided<[1], offset: 2>> to memref<1xi32, strided<[1], offset: 2>>
    %collapse_shape_98 = memref.collapse_shape %subview_97 [] : memref<1xi32, strided<[1], offset: 2>> into memref<i32, strided<[], offset: 2>>
    %35 = memref.load %collapse_shape_98[] : memref<i32, strided<[], offset: 2>>
    %subview_99 = memref.subview %collapse_shape_88[1] [1] [1] : memref<2xi32, strided<[1], offset: 2>> to memref<1xi32, strided<[1], offset: 3>>
    %collapse_shape_100 = memref.collapse_shape %subview_99 [] : memref<1xi32, strided<[1], offset: 3>> into memref<i32, strided<[], offset: 3>>
    %36 = memref.load %collapse_shape_100[] : memref<i32, strided<[], offset: 3>>
    %37 = arith.xori %35, %36 : i32
    %38 = arith.xori %37, %c466688986_i32 : i32
    %39 = memref.load %collapse_shape_98[] : memref<i32, strided<[], offset: 2>>
    %40 = memref.load %collapse_shape_100[] : memref<i32, strided<[], offset: 3>>
    %41 = memref.load %collapse_shape_100[] : memref<i32, strided<[], offset: 3>>
    %42 = memref.load %collapse_shape_98[] : memref<i32, strided<[], offset: 2>>
    memref.dealloc %alloc_84 : memref<2x2xi32>
    %alloc_101 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
    memref.copy %6, %alloc_101 : memref<4xi32> to memref<4xi32>
    %alloc_102 = memref.alloc() {alignment = 64 : i64} : memref<4xi32>
    memref.copy %5, %alloc_102 : memref<4xi32> to memref<4xi32>
    %alloc_103 = memref.alloc() : memref<4xi32>
    memref.copy %alloc_101, %alloc_103 : memref<4xi32> to memref<4xi32>
    memref.dealloc %alloc_101 : memref<4xi32>
    %alloc_104 = memref.alloc() : memref<4xi32>
    memref.copy %alloc_102, %alloc_104 : memref<4xi32> to memref<4xi32>
    memref.dealloc %alloc_102 : memref<4xi32>
    %43:8 = scf.for %arg8 = %c0_i64 to %c5_i64 step %c1_i64 iter_args(%arg9 = %c0_i64, %arg10 = %39, %arg11 = %40, %arg12 = %41, %arg13 = %38, %arg14 = %42, %arg15 = %alloc_103, %arg16 = %alloc_104) -> (i64, i32, i32, i32, i32, i32, memref<4xi32>, memref<4xi32>)  : i64 {
      %87 = arith.addi %arg9, %c1_i64 : i64
      %subview_121 = memref.subview %arg15[0] [1] [1] : memref<4xi32> to memref<1xi32, strided<[1]>>
      %collapse_shape_122 = memref.collapse_shape %subview_121 [] : memref<1xi32, strided<[1]>> into memref<i32>
      %88 = memref.load %collapse_shape_122[] : memref<i32>
    ...
    memref.dealloc %43#7 : memref<4xi32>
    memref.dealloc %43#6 : memref<4xi32>
    %44 = arith.extui %43#1 : i32 to i64
    %45 = arith.extui %43#2 : i32 to i64
    %46 = arith.shli %44, %c32_i64 : i64
    %47 = arith.ori %46, %45 : i64
    %48 = arith.remui %34, %c96_i64 : i64
    %49 = arith.muli %48, %c64_i64 : i64
    %50 = arith.remui %47, %c96_i64 : i64
    %51 = arith.addi %49, %50 : i64
    %52 = arith.remui %51, %c96_i64 : i64
    %53 = memref.load %arg1[] : memref<f32>
    %54 = memref.load %arg2[] : memref<f32>
    %alloc_105 = memref.alloc() {alignment = 64 : i64} : memref<f32>
    %alloc_106 = memref.alloc() {alignment = 64 : i64} : memref<f32>
    %alloc_107 = memref.alloc() {alignment = 64 : i64} : memref<4x8x3xf32>
    %alloc_108 = memref.alloc() {alignment = 64 : i64} : memref<8xf32>
    %alloc_109 = memref.alloc() {alignment = 64 : i64} : memref<f64>
    %alloc_110 = memref.alloc() : memref<4x8x3xf32>
    %alloc_111 = memref.alloc() : memref<f32>
    %alloc_112 = memref.alloc() : memref<f32>
    %alloc_113 = memref.alloc() : memref<f64>
    %alloc_114 = memref.alloc() {alignment = 64 : i64} : memref<4x8x3xf32>
    %alloc_115 = memref.alloc() : memref<4x8x3xf32>
    memref.copy %arg0, %alloc_115 : memref<4x8x3xf32> to memref<4x8x3xf32>
    %55:5 = scf.for %arg8 = %c0 to %c3 step %c1 iter_args(%arg9 = %alloc_115, %arg10 = %53, %arg11 = %54, %arg12 = %cst_4, %arg13 = %cst_4) -> (memref<4x8x3xf32>, f32, f32, f64, f64) {
      memref.store %arg10, %alloc_105[] : memref<f32>
      memref.store %arg11, %alloc_106[] : memref<f32>
      %87 = arith.index_cast %arg8 : index to i64
      %alloc_121 = memref.alloc() {alignment = 64 : i64} : memref<4x8x3xf32>
      linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> ()>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%3 : memref<f32>) outs(%alloc_107 : memref<4x8x3xf32>) {
      ^bb0(%in: f32, %out: f32):
        linalg.yield %in : f32
      }
      %alloc_122 = memref.alloc() : memref<4x8x3xf32>
      memref.copy %alloc_107, %alloc_122 : memref<4x8x3xf32> to memref<4x8x3xf32>
      %88:4 = scf.for %arg14 = %c0 to %c32 step %c1 iter_args(%arg15 = %alloc_122, %arg16 = %cst_4, %arg17 = %cst_4, %arg18 = %cst_4) -> (memref<4x8x3xf32>, f64, f64, f64) {
        %99 = arith.index_cast %arg14 : index to i64
        %100 = arith.muli %87, %c32_i64 : i64
        %101 = arith.addi %52, %100 : i64
        %102 = arith.addi %101, %99 : i64
        %103 = arith.remsi %102, %c96_i64 : i64
        %104 = arith.cmpi ne, %103, %c0_i64 : i64
        %105 = arith.cmpi slt, %103, %c0_i64 : i64
        %106 = arith.andi %105, %104 : i1
        %107 = arith.addi %103, %c96_i64 : i64
        %108 = arith.select %106, %107, %103 : i64
        %109 = arith.cmpi slt, %108, %c0_i64 : i64
        %110 = arith.addi %108, %c96_i64 : i64
        %111 = arith.select %109, %110, %108 : i64
        %112 = arith.index_cast %111 : i64 to index
        %113 = arith.maxsi %112, %c0 : index
        %114 = arith.minsi %113, %c95 : index
        %subview_124 = memref.subview %arg5[%114, 0] [1, 8] [1, 1] : memref<96x8xf32> to memref<1x8xf32, strided<[8, 1], offset: ?>>
        %collapse_shape_125 = memref.collapse_shape %subview_124 [[0, 1]] : memref<1x8xf32, strided<[8, 1], offset: ?>> into memref<8xf32, strided<[1], offset: ?>>
        %subview_126 = memref.subview %arg6[%114] [1] [1] : memref<96xf32> to memref<1xf32, strided<[1], offset: ?>>
        %collapse_shape_127 = memref.collapse_shape %subview_126 [] : memref<1xf32, strided<[1], offset: ?>> into memref<f32, strided<[], offset: ?>>
        %115 = memref.load %collapse_shape_127[] : memref<f32, strided<[], offset: ?>>
        %subview_128 = memref.subview %arg7[%114] [1] [1] : memref<96xf32> to memref<1xf32, strided<[1], offset: ?>>
        %collapse_shape_129 = memref.collapse_shape %subview_128 [] : memref<1xf32, strided<[1], offset: ?>> into memref<f32, strided<[], offset: ?>>
        %116 = memref.load %collapse_shape_129[] : memref<f32, strided<[], offset: ?>>
        memref.copy %collapse_shape_125, %alloc_108 : memref<8xf32, strided<[1], offset: ?>> to memref<8xf32>
        %117 = func.call @qnode_forward_0(%arg9, %alloc_108) : (memref<4x8x3xf32>, memref<8xf32>) -> memref<f64>
        %118 = memref.load %117[] : memref<f64>
        %119 = arith.extf %arg11 : f32 to f64
        %120 = arith.mulf %119, %118 : f64
        %121 = arith.extf %arg10 : f32 to f64
        %122 = arith.addf %120, %121 : f64
        %123 = arith.extf %115 : f32 to f64
        %124 = arith.extf %116 : f32 to f64
        %125 = arith.maximumf %122, %cst_4 : f64
        %126 = arith.cmpf une, %122, %122 : f64
        %127 = math.absf %122 : f64
        %128 = arith.negf %127 : f64
        %129 = math.exp %128 : f64
        %130 = math.log1p %129 : f64
        %131 = arith.addf %125, %130 : f64
        %132 = arith.select %126, %122, %131 : f64
        %133 = arith.mulf %123, %122 : f64
        %134 = arith.subf %132, %133 : f64
        %135 = arith.mulf %124, %134 : f64
        linalg.fill ins(%cst_4 : f64) outs(%alloc_109 : memref<f64>)
        memref.store %cst_3, %alloc_109[] : memref<f64>
        gradient.backprop @_sample_loss.cloned(%arg9, %alloc_105, %alloc_106, %collapse_shape_125, %collapse_shape_127, %collapse_shape_129) grad_out(%alloc_110, %alloc_111, %alloc_112 : memref<4x8x3xf32>, memref<f32>, memref<f32>) callee_out(%alloc_113 : memref<f64>) cotangents(%alloc_109 : memref<f64>) {diffArgIndices = dense<[0, 1, 2]> : tensor<3xi64>, keepValueResults = false, resultSegmentSizes = array<i32: 0, 0>} : (memref<4x8x3xf32>, memref<f32>, memref<f32>, memref<8xf32, strided<[1], offset: ?>>, memref<f32, strided<[], offset: ?>>, memref<f32, strided<[], offset: ?>>) -> ()
        %136 = memref.load %alloc_112[] : memref<f32>
        %137 = memref.load %alloc_111[] : memref<f32>
        linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg15, %alloc_110 : memref<4x8x3xf32>, memref<4x8x3xf32>) outs(%alloc_121 : memref<4x8x3xf32>) {
        ^bb0(%in: f32, %in_132: f32, %out: f32):
          %143 = arith.addf %in, %in_132 : f32
          linalg.yield %143 : f32
        }
        memref.dealloc %arg15 : memref<4x8x3xf32>
        %138 = arith.extf %137 : f32 to f64
        %139 = arith.addf %arg16, %138 : f64
        %140 = arith.extf %136 : f32 to f64
        %141 = arith.addf %arg17, %140 : f64
        %142 = arith.addf %arg18, %135 : f64
        %alloc_130 = memref.alloc() {alignment = 64 : i64} : memref<4x8x3xf32>
        memref.copy %alloc_121, %alloc_130 : memref<4x8x3xf32> to memref<4x8x3xf32>
        %alloc_131 = memref.alloc() : memref<4x8x3xf32>
        memref.copy %alloc_130, %alloc_131 : memref<4x8x3xf32> to memref<4x8x3xf32>
        memref.dealloc %alloc_130 : memref<4x8x3xf32>
        scf.yield %alloc_131, %139, %141, %142 : memref<4x8x3xf32>, f64, f64, f64
      }
      linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> ()>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%1 : memref<f32>) outs(%alloc_121 : memref<4x8x3xf32>) {
      ^bb0(%in: f32, %out: f32):
        linalg.yield %in : f32
      }
      linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%88#0, %alloc_121 : memref<4x8x3xf32>, memref<4x8x3xf32>) outs(%alloc_114 : memref<4x8x3xf32>) {
      ^bb0(%in: f32, %in_124: f32, %out: f32):
        %99 = arith.mulf %in, %in_124 : f32
        linalg.yield %99 : f32
      }
      memref.dealloc %88#0 : memref<4x8x3xf32>
      linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> ()>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%2 : memref<f32>) outs(%alloc_121 : memref<4x8x3xf32>) {
      ^bb0(%in: f32, %out: f32):
        linalg.yield %in : f32
      }
      linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%alloc_121, %alloc_114 : memref<4x8x3xf32>, memref<4x8x3xf32>) outs(%alloc_121 : memref<4x8x3xf32>) {
      ^bb0(%in: f32, %in_124: f32, %out: f32):
        %99 = arith.mulf %in, %in_124 : f32
        linalg.yield %99 : f32
      }
      linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg9, %alloc_121 : memref<4x8x3xf32>, memref<4x8x3xf32>) outs(%alloc_121 : memref<4x8x3xf32>) {
      ^bb0(%in: f32, %in_124: f32, %out: f32):
        %99 = arith.subf %in, %in_124 : f32
        linalg.yield %99 : f32
      }
      memref.dealloc %arg9 : memref<4x8x3xf32>
      %89 = arith.mulf %88#1, %cst : f64
      %90 = arith.truncf %89 : f64 to f32
      %91 = arith.mulf %90, %cst_2 : f32
      %92 = arith.subf %arg10, %91 : f32
      %93 = arith.mulf %88#2, %cst : f64
      %94 = arith.truncf %93 : f64 to f32
      %95 = arith.mulf %94, %cst_2 : f32
      %96 = arith.subf %arg11, %95 : f32
      %97 = arith.divf %88#3, %cst_1 : f64
      %98 = arith.addf %arg12, %97 : f64
      %alloc_123 = memref.alloc() : memref<4x8x3xf32>
      memref.copy %alloc_121, %alloc_123 : memref<4x8x3xf32> to memref<4x8x3xf32>
      memref.dealloc %alloc_121 : memref<4x8x3xf32>
      scf.yield %alloc_123, %92, %96, %98, %97 : memref<4x8x3xf32>, f32, f32, f64, f64
    }
    memref.dealloc %alloc_114 : memref<4x8x3xf32>
    memref.dealloc %alloc_113 : memref<f64>
    memref.dealloc %alloc_112 : memref<f32>
    memref.dealloc %alloc_111 : memref<f32>
    memref.dealloc %alloc_110 : memref<4x8x3xf32>
    memref.dealloc %alloc_109 : memref<f64>
    memref.dealloc %alloc_108 : memref<8xf32>
    memref.dealloc %alloc_107 : memref<4x8x3xf32>
    memref.dealloc %alloc_106 : memref<f32>
    memref.dealloc %alloc_105 : memref<f32>
    %alloc_116 = memref.alloc() {alignment = 64 : i64} : memref<f32>
    memref.store %55#1, %alloc_116[] : memref<f32>
    %alloc_117 = memref.alloc() {alignment = 64 : i64} : memref<f32>
    memref.store %55#2, %alloc_117[] : memref<f32>
    %56 = arith.divf %55#3, %cst_0 : f64
    %alloc_118 = memref.alloc() {alignment = 64 : i64} : memref<1xf64>
    memref.store %56, %alloc_118[%c0] : memref<1xf64>
    %alloc_119 = memref.alloc() {alignment = 64 : i64} : memref<1xf64>
    memref.store %55#4, %alloc_119[%c0] : memref<1xf64>
    %alloc_120 = memref.alloc() {alignment = 64 : i64} : memref<2xf64>
    linalg.generic {indexing_maps = [affine_map<(d0) -> (d0)>], iterator_types = ["parallel"]} outs(%alloc_120 : memref<2xf64>) {
    ^bb0(%out: f64):
      %87 = linalg.index 0 : index
      %88 = arith.cmpi ult, %87, %c1 : index
      %89 = scf.if %88 -> (f64) {
        %90 = memref.load %alloc_118[%87] : memref<1xf64>
        scf.yield %90 : f64
      } else {
        %90 = arith.subi %87, %c1 : index
        %91 = memref.load %alloc_119[%90] : memref<1xf64>
        scf.yield %91 : f64
      }
      linalg.yield %89 : f64
    }
    memref.dealloc %alloc_119 : memref<1xf64>
    memref.dealloc %alloc_118 : memref<1xf64>
    %cast = memref.cast %collapse_shape_42 : memref<2xi32, strided<[1]>> to memref<2xi32>
    %57 = builtin.unrealized_conversion_cast %55#0 : memref<4x8x3xf32> to !llvm.struct<(ptr, ptr, i64, array<3 x i64>, array<3 x i64>)>
    %58 = llvm.extractvalue %57[0] : !llvm.struct<(ptr, ptr, i64, array<3 x i64>, array<3 x i64>)> 
    %59 = llvm.ptrtoint %58 : !llvm.ptr to i64
    %60 = llvm.icmp "eq" %0, %59 : i64
    %61 = scf.if %60 -> (memref<4x8x3xf32>) {
      %alloc_121 = memref.alloc() : memref<4x8x3xf32>
      memref.copy %55#0, %alloc_121 : memref<4x8x3xf32> to memref<4x8x3xf32>
      scf.yield %alloc_121 : memref<4x8x3xf32>
    } else {
      scf.yield %55#0 : memref<4x8x3xf32>
    }
    %62 = builtin.unrealized_conversion_cast %alloc_116 : memref<f32> to !llvm.struct<(ptr, ptr, i64)>
    %63 = llvm.extractvalue %62[0] : !llvm.struct<(ptr, ptr, i64)> 
    %64 = llvm.ptrtoint %63 : !llvm.ptr to i64
    %65 = llvm.icmp "eq" %0, %64 : i64
    %66 = scf.if %65 -> (memref<f32>) {
      %alloc_121 = memref.alloc() : memref<f32>
      memref.copy %alloc_116, %alloc_121 : memref<f32> to memref<f32>
      scf.yield %alloc_121 : memref<f32>
    } else {
      scf.yield %alloc_116 : memref<f32>
    }
    %67 = builtin.unrealized_conversion_cast %alloc_117 : memref<f32> to !llvm.struct<(ptr, ptr, i64)>
    %68 = llvm.extractvalue %67[0] : !llvm.struct<(ptr, ptr, i64)> 
    %69 = llvm.ptrtoint %68 : !llvm.ptr to i64
    %70 = llvm.icmp "eq" %0, %69 : i64
    %71 = scf.if %70 -> (memref<f32>) {
      %alloc_121 = memref.alloc() : memref<f32>
      memref.copy %alloc_117, %alloc_121 : memref<f32> to memref<f32>
      scf.yield %alloc_121 : memref<f32>
    } else {
      scf.yield %alloc_117 : memref<f32>
    }
    %72 = builtin.unrealized_conversion_cast %arg3 : memref<i32> to !llvm.struct<(ptr, ptr, i64)>
    %73 = llvm.extractvalue %72[0] : !llvm.struct<(ptr, ptr, i64)> 
    %74 = llvm.ptrtoint %73 : !llvm.ptr to i64
    %75 = llvm.icmp "eq" %0, %74 : i64
    %76 = scf.if %75 -> (memref<i32>) {
      %alloc_121 = memref.alloc() : memref<i32>
      memref.copy %arg3, %alloc_121 : memref<i32> to memref<i32>
      scf.yield %alloc_121 : memref<i32>
    } else {
      scf.yield %arg3 : memref<i32>
    }
    %77 = builtin.unrealized_conversion_cast %cast : memref<2xi32> to !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %78 = llvm.extractvalue %77[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %79 = llvm.ptrtoint %78 : !llvm.ptr to i64
    %80 = llvm.icmp "eq" %0, %79 : i64
    %81 = scf.if %80 -> (memref<2xi32>) {
      %alloc_121 = memref.alloc() : memref<2xi32>
      memref.copy %collapse_shape_42, %alloc_121 : memref<2xi32, strided<[1]>> to memref<2xi32>
      scf.yield %alloc_121 : memref<2xi32>
    } else {
      scf.yield %cast : memref<2xi32>
    }
    %82 = builtin.unrealized_conversion_cast %alloc_120 : memref<2xf64> to !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %83 = llvm.extractvalue %82[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %84 = llvm.ptrtoint %83 : !llvm.ptr to i64
    %85 = llvm.icmp "eq" %0, %84 : i64
    %86 = scf.if %85 -> (memref<2xf64>) {
      %alloc_121 = memref.alloc() : memref<2xf64>
      memref.copy %alloc_120, %alloc_121 : memref<2xf64> to memref<2xf64>
      scf.yield %alloc_121 : memref<2xf64>
    } else {
      scf.yield %alloc_120 : memref<2xf64>
    }
    return %61, %66, %71, %76, %81, %86 : memref<4x8x3xf32>, memref<f32>, memref<f32>, memref<i32>, memref<2xi32>, memref<2xf64>
  }
  ...
  func.func private @_sample_loss.cloned(%arg0: memref<4x8x3xf32>, %arg1: memref<f32>, %arg2: memref<f32>, %arg3: memref<8xf32>, %arg4: memref<f32>, %arg5: memref<f32>) -> memref<f64> attributes {llvm.linkage = #llvm.linkage<internal>} {
    %cst = arith.constant 0.000000e+00 : f64
    %0 = call @qnode_forward_0.pcount(%arg0, %arg3) : (memref<4x8x3xf32>, memref<8xf32>) -> index
    %1 = memref.load %arg5[] : memref<f32>
    %2 = memref.load %arg4[] : memref<f32>
    %3 = memref.load %arg1[] : memref<f32>
    %4 = memref.load %arg2[] : memref<f32>
    %5 = call @qnode_forward_0.preprocess(%arg0, %arg3, %0) : (memref<4x8x3xf32>, memref<8xf32>, index) -> memref<f64>
    %6 = memref.load %5[] : memref<f64>
    %7 = arith.extf %4 : f32 to f64
    %8 = arith.mulf %7, %6 : f64
    %9 = arith.extf %3 : f32 to f64
    %10 = arith.addf %8, %9 : f64
    %11 = arith.extf %2 : f32 to f64
    %12 = arith.extf %1 : f32 to f64
    %13 = arith.maximumf %10, %cst : f64
    %14 = arith.cmpf une, %10, %10 : f64
    %15 = math.absf %10 : f64
    %16 = arith.negf %15 : f64
    %17 = math.exp %16 : f64
    %18 = math.log1p %17 : f64
    %19 = arith.addf %13, %18 : f64
    %20 = arith.select %14, %10, %19 : f64
    %21 = arith.mulf %11, %10 : f64
    %22 = arith.subf %20, %21 : f64
    %23 = arith.mulf %12, %22 : f64
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<f64>
    memref.store %23, %alloc[] : memref<f64>
    return %alloc : memref<f64>
  }
  func.func @setup() {
    quantum.init
