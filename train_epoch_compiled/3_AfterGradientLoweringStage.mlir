module @train_epoch_compiled {
  func.func public @jit_train_epoch_compiled(%arg0: tensor<4x8x3xf32>, %arg1: tensor<f32>, %arg2: tensor<f32>, %arg3: tensor<i32>, %arg4: tensor<2xi32>, %arg5: tensor<96x8xf32>, %arg6: tensor<96xf32>, %arg7: tensor<96xf32>) -> (tensor<4x8x3xf32>, tensor<f32>, tensor<f32>, tensor<i32>, tensor<2xi32>, tensor<2xf64>) attributes {llvm.emit_c_interface} {
    ...
    %2:5 = scf.for %arg8 = %c0 to %c3 step %c1 iter_args(%arg9 = %arg0, %arg10 = %extracted, %arg11 = %extracted_9, %arg12 = %cst, %arg13 = %cst) -> (tensor<4x8x3xf32>, f32, f32, f64, f64) {
      ...
      %9:4 = scf.for %arg14 = %c0 to %c32 step %c1 iter_args(%arg15 = %8, %arg16 = %cst, %arg17 = %cst, %arg18 = %cst) -> (tensor<4x8x3xf32>, f64, f64, f64) {
        ...
        %47:3 = func.call @_sample_loss.fullgrad012(%arg9, %from_elements_13, %from_elements_14, %collapsed_16, %collapsed_18, %collapsed_21) : (tensor<4x8x3xf32>, tensor<f32>, tensor<f32>, tensor<8xf32>, tensor<f32>, tensor<f32>) -> (tensor<4x8x3xf32>, tensor<f32>, tensor<f32>)
  ...
  func.func private @_sample_loss.cloned(%arg0: tensor<4x8x3xf32>, %arg1: tensor<f32>, %arg2: tensor<f32>, %arg3: tensor<8xf32>, %arg4: tensor<f32>, %arg5: tensor<f32>) -> tensor<f64> attributes {llvm.linkage = #llvm.linkage<internal>} {
    %0 = call @qnode_forward_0.pcount(%arg0, %arg3) : (tensor<4x8x3xf32>, tensor<8xf32>) -> index
    %extracted = tensor.extract %arg5[] : tensor<f32>
    %extracted_0 = tensor.extract %arg4[] : tensor<f32>
    %extracted_1 = tensor.extract %arg1[] : tensor<f32>
    %extracted_2 = tensor.extract %arg2[] : tensor<f32>
    %1 = call @qnode_forward_0.preprocess(%arg0, %arg3, %0) : (tensor<4x8x3xf32>, tensor<8xf32>, index) -> tensor<f64>
    %extracted_3 = tensor.extract %1[] : tensor<f64>
    %2 = arith.extf %extracted_2 : f32 to f64
    %3 = arith.mulf %2, %extracted_3 : f64
    %4 = arith.extf %extracted_1 : f32 to f64
    %5 = arith.addf %3, %4 : f64
    %6 = arith.extf %extracted_0 : f32 to f64
    %7 = arith.extf %extracted : f32 to f64
    %8 = call @softplus_2.detensorized(%5) : (f64) -> f64
    %9 = arith.mulf %6, %5 : f64
    %10 = arith.subf %8, %9 : f64
    %11 = arith.mulf %7, %10 : f64
    %from_elements = tensor.from_elements %11 : tensor<f64>
    return %from_elements : tensor<f64>
  }
  func.func private @_sample_loss.fullgrad012(%arg0: tensor<4x8x3xf32>, %arg1: tensor<f32>, %arg2: tensor<f32>, %arg3: tensor<8xf32>, %arg4: tensor<f32>, %arg5: tensor<f32>) -> (tensor<4x8x3xf32>, tensor<f32>, tensor<f32>) {
    %cst = arith.constant 0.000000e+00 : f64
    ...
    %gradients:3 = gradient.backprop @_sample_loss.cloned(%arg0, %arg1, %arg2, %arg3, %arg4, %arg5) cotangents(%inserted : tensor<f64>) {diffArgIndices = dense<[0, 1, 2]> : tensor<3xi64>, keepValueResults = false, resultSegmentSizes = array<i32: 0, 3>} : (tensor<4x8x3xf32>, tensor<f32>, tensor<f32>, tensor<8xf32>, tensor<f32>, tensor<f32>) -> (tensor<4x8x3xf32>, tensor<f32>, tensor<f32>)
    return %gradients#0, %gradients#1, %gradients#2 : tensor<4x8x3xf32>, tensor<f32>, tensor<f32>
  }
  func.func @setup() {
    quantum.init
    return
